...
public class CustomDateTimePicker implements OnClickListener {
	...
	public View getDateTimePickerLayout() {
		...
		button_params.setMargins(2, 2, 2, 2);
		
		linear_match_wrap.setMargins(2, 2, 2, 2);
	...
	public void onClick(View v) {
		...
		case SET_DATE:
			...
			btn_setDate.setBackgroundResource(R.drawable.checkin_request_btn);
			btn_setTime.setBackgroundResource(R.drawable.completed_btn);
		...
		case SET_TIME:
			...
			btn_setTime.setBackgroundResource(R.drawable.checkin_request_btn);
			btn_setDate.setBackgroundResource(R.drawable.completed_btn);
